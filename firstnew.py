...
class first(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.network_tcp_sink_1 = network.tcp_sink(gr.sizeof_gr_complex, 1, '127.0.0.1', 6000,2)
        ...
        # Connections
        ##################################################
        self.connect((self.iridium_fft_burst_tagger_0, 0), (self.iridium_iuchar_to_complex_0, 0))
        self.connect((self.iridium_iuchar_to_complex_0, 0), (self.network_tcp_sink_1, 0))
