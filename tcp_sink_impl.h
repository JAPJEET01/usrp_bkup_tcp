...
protected:
    ...
    int freq_flag, start_flag, meanVec_flag, ch_flag, oneCount, meanVecCount, chCounter, chCounter1, total_chs, s_cycle;
    int one_last_flag, single_time_freq_flag, last_flag_for_meanvec, last_flag_for_ch;
