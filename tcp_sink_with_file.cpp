                        ...
                        gr_vector_void_star& output_items)
{
    ...
    if (((single_time_freq_flag + (meanVec_flag+last_flag_for_meanvec) + last_flag_for_ch) > 0)){
        fwrite(real_parts_buffer, sizeof(real_parts_buffer[0]), sizeof(real_parts_buffer), s1);
    }
